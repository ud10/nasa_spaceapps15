 ...
 */
public class Mars5Activity extends CardboardActivity implements
...
//        Context context = Mars5Activity.this;
//        CharSequence text = "YES! I found NO3! Biologically-useful nitrogen, that is. Another sign ancient Mars=habitable";
//        int duration = Toast.LENGTH_LONG;
//
//        Toast toast = Toast.makeText(context, text, duration);
//        toast.show();

        mOverlayView.show3DImage(mScore, Mars5Activity.this);
    }
    ...
    public void onCardboardTrigger() {
        ...
        Intent intent = new Intent(Mars5Activity.this, Mars6Activity.class);
